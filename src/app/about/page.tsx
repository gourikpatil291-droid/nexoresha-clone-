      ...
      <div className="pt-32 pb-8 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <nav className="flex justify-center items-center space-x-2 text-[10px] md:text-xs font-display uppercase tracking-widest text-warm-beige/40 mb-4 select-none">
            ...
            <span>&mdash;</span>
            <span className="text-luxury-gold">About</span>
          </nav>
          ...
          <p className="text-sm md:text-base font-sans text-warm-beige/60 max-w-2xl mx-auto">
            Meet the team and understand the vision behind NEXORESHA — where innovation, premium design, and custom 3D technologies intersect.
          </p>
        </div>
      </div>
